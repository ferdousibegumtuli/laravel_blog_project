                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-body">
                            <img loading="lazy" decoding="async" src="/images/frontend/images.png" alt="About Me"
                                class="w-100 author-thumb-sm d-block" style="height: 200px;">
                            <h2 class="widget-title my-3">Tech Trends</h2>
                            <p class="mb-3 pb-2">
